package tasks_Stacks_Queues_3.SetOfStacks;
...
public class SetOfStacks {
	...
	public static void main(String args[]) {
		...
		System.out.println("set.popAt(0): " + set.popAt(0));
		for (int i = 0; i < 33; i++) {
...
// popO should return the same values as it would if there were just a single
// stack).
// FOLLOW UP
